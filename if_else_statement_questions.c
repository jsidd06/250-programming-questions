...
QUES 26 Input all sides of a triangle and check whether the triangle is valid or not?
#include<stdio.h>
int main(){
    int num1, num2,num3;
    printf("enter the three sides of triangle value:-");
    scanf("%d %d %d",&num1,&num2,&num3);
    if((num1 + num2) > num3){
        if((num2 + num3) > num1){
            if((num3 + num1) > num2){
...
QUES 27 Check whether the triangle is an equilateral, isosceles or scalene triangle?
#include <stdio.h>
int main()
{
    int num1, num2, num3;
